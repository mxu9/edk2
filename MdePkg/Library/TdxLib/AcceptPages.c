...
#define ACCEPT_PAGE_SIZE_4K   0
#define ACCEPT_PAGE_SIZE_2M   1
#define ACCEPT_PAGE_SIZE_1G   2
  ...
  )
{
  ...
  if (PageSize == SIZE_4KB) {
    GpaPageSize = ACCEPT_PAGE_SIZE_4K;
  } else if(PageSize == SIZE_2MB) {
    GpaPageSize = ACCEPT_PAGE_SIZE_2M;
  } else if(PageSize == SIZE_1GB) {
    GpaPageSize = ACCEPT_PAGE_SIZE_1G;
  } else {
