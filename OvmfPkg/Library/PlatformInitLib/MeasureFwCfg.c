  ...
  )
{
  ...
  FwCfhHobData = BuildGuidHob (&gOvmfFwCfgInfoHobGuid, TotalSize + sizeof (FW_CFG_SELECT_INFO));
  ...
  CachedItem = (FW_CFG_CACHED_ITEM *)(FwCfhHobData + sizeof (FW_CFG_SELECT_INFO));
