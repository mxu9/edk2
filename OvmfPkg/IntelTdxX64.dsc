...
[Defines]
  ...
  FLASH_DEFINITION               = OvmfPkg/IntelTdxX64.fdf
...
!endif
  ...
  #
  # Add INTEL_TDX_CONFIG_B
  #
  MSFT:*_*_*_CC_FLAGS = /D INTEL_TDX_CONFIG_B
  INTEL:*_*_*_CC_FLAGS = /D INTEL_TDX_CONFIG_B
  GCC:*_*_*_CC_FLAGS = -D INTEL_TDX_CONFIG_B
...
!endif
  ...
  #PrePiLib|OvmfPkg/IntelTdx/PrePiLibTdx/PrePiLibTdx.inf
